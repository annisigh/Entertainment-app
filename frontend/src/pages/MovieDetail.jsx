...
const MovieDetail = () => {
	...
	const { mediaId } = useParams(); //Destructuring the mediaId parameter from the URL parameters using useParams.

	//Initializing the mediaDetail state variable using useState to store the fetched movie detail.
	// State to store fetched media detail
	const [mediaDetail, setMediaDetail] = useState();

	//Fetching movie detail using the useFetchMediaDetail 
	//custom hook when the component mounts or mediaId changes.
	...
	return (
		<>
		{/* If mediaDetail is available, rendering movie details. */}
		{/* If mediaDetail is not available, rendering a loading spinner using the DNA component. */}
