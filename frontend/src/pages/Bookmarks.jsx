...
const Bookmarks = () => {
    ...
    //If the user is not logged in (i.e., there is no cookie), the user is redirected to the /signup route.
	//If the user is logged in, the loading state is set to false.
